...
class Deal extends Validate
{
    ...
    protected $rule = [
        ...
        ['start_time', 'regex:\d{4}-\d{,2}-\d{,2} \d{,2}:\d{,2}', '团购开始时间格式不符'],
        ['end_time', 'require', '团购结束时间不能为空'],
        ['end_time', 'regex:\d{4}-\d{,2}-\d{,2} \d{,2}:\d{,2}', '团购结束时间格式不符'],
        ...
        ['coupons_begin_time', 'regex:\d{4}-\d{,2}-\d{,2} \d{,2}:\d{,2}', '消费券生效时间格式不符'],
        ['coupons_end_time', 'require', '消费券结束时间不能为空'],
        ['coupons_end_time', 'regex:\d{4}-\d{,2}-\d{,2} \d{,2}:\d{,2}', '消费券结束时间格式不符'],
